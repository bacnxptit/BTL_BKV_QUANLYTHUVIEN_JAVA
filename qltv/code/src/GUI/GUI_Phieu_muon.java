...
public class GUI_Phieu_muon extends JFrame {
	...
	private JPanel contentPane;// thuộc tính đẻ chứa các thành phần giao diện người dùng
	private JTable table;
	
	
	DefaultTableModel Model = new DefaultTableModel();//quản lí dữ liệu và cột trong bảng
